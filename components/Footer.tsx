          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Ayodhya</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              A sacred sanctuary in the heart of Ayodhya, providing comfortable accommodation 
              for pilgrims and spiritual seekers near Ram Mandir.
            </p>
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p>{BUSINESS_INFO.address.postalCode}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={CONTACT_LINKS.phone} className="text-sm hover:text-white transition-colors">
                  {BUSINESS_INFO.phone}
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={CONTACT_LINKS.email} className="text-sm hover:text-white transition-colors">
                  {BUSINESS_INFO.email}
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-sm">
              <p>&copy; 2024 {BUSINESS_INFO.legalName}. All rights reserved.</p>
              <p className="mt-1">Registered Charitable Trust | Serving Pilgrims Since {BUSINESS_INFO.foundingDate}</p>
            </div>
