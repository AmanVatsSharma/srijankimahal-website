...
4. Enter your website URL: `https://srijanakimahaltrust.in`
5. Click "Continue"
...
2. Enter: `https://srijanakimahaltrust.in/sitemap-index.xml`
3. Click "Submit"
4. Wait for Google to process (may take a few hours)

### Alternative Sitemap URLs

If the sitemap index doesn't work, try:
- `https://srijanakimahaltrust.in/sitemap-0.xml`
- Or check the actual sitemap URL in your `dist/` folder after building
...
2. Enter: `https://srijanakimahaltrust.in`
...
**Solutions:**
1. Check that sitemap is accessible: Visit `https://srijanakimahaltrust.in/sitemap-index.xml`
2. Ensure sitemap is in the `public/` directory or generated by Astro
3. Verify the sitemap URL is correct
4. Check robots.txt includes sitemap reference
