...
export const defaultFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: `You can book rooms at Sri Janaki Mahal Trust by calling ${DISPLAY_PHONE} or messaging us on WhatsApp at ${WHATSAPP_LINK}. We offer advance online booking for all room types. Our team is available 24/7 to assist with reservations and answer any questions.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Room prices at Sri Janaki Mahal Trust range from ₹1,250 to ₹4,150 per night, depending on room type and amenities. All prices include meals. For current rates and availability, please call ${DISPLAY_PHONE} or message us on WhatsApp.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Sri Janaki Mahal Trust is located at Vasudev Gath, Karsewakpuram, Ayodhya. You can reach us by train (Ayodhya Railway Station), bus (Ayodhya Bus Stand), or by road. We are easily accessible from all major cities. For detailed directions, call ${DISPLAY_PHONE}.`,
  },
  {
    question: 'How to book room at Sri Janaki Mahal Trust?',
    answer: `To book a room at Sri Janaki Mahal Trust, call our official number ${DISPLAY_PHONE}, message us on WhatsApp at ${DISPLAY_PHONE}, or visit our booking page. Provide your check-in date, check-out date, number of guests, and preferred room type. We will confirm availability and provide booking details.`,
  },
  {
  ...
  },
  {
    ...
    answer: `The official phone number of Sri Janaki Mahal Trust is ${DISPLAY_PHONE}. This is our official contact number available 24/7 for bookings, inquiries, and support. You can also reach us on WhatsApp at the same number.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, you can book rooms at Sri Janaki Mahal Trust online through our official channels. Contact us via WhatsApp (${DISPLAY_PHONE}) or phone (${DISPLAY_PHONE}) for instant booking. We also have a booking page on our official website for booking inquiries.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Sri Janaki Mahal Trust is a registered charitable trust established in 2020. For official registration details and verification, please contact us at ${DISPLAY_PHONE} or visit our official website. We operate with complete transparency and legal compliance.`,
  },
  {
    question: 'Does Sri Janaki Mahal Trust have online booking?',
    answer: `Yes, Sri Janaki Mahal Trust offers online booking through our official website and WhatsApp. Contact us at ${DISPLAY_PHONE} via phone or WhatsApp for instant booking confirmation. We provide booking confirmation immediately upon reservation.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Room prices at Sri Janaki Mahal Trust: 2-bed rooms ₹1,250-₹2,100, 3-bed rooms ₹1,800-₹3,000, 4-bed rooms ₹2,550-₹3,500, Deluxe/Luxury suites ₹3,200-₹4,150. All prices include all meals. Contact ${DISPLAY_PHONE} for current rates and availability.`,
  },
  {
    question: 'Is Sri Janaki Mahal Trust authentic?',
    answer: `Yes, Sri Janaki Mahal Trust is an authentic registered charitable trust providing genuine comfortable accommodation services in Ayodhya. We have been serving guests since 2020 with verified business credentials. Always verify through our official contact: ${DISPLAY_PHONE}.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, Sri Janaki Mahal Trust accepts advance bookings. We recommend booking 2-4 weeks in advance for regular days, and 2-3 months in advance during festivals like Ram Navami and Diwali. Contact ${DISPLAY_PHONE} to make advance reservations.`,
  },
  {
    question: 'What is the booking process at Sri Janaki Mahal Trust?',
    answer: `Booking process: 1) Contact us via phone/WhatsApp (${DISPLAY_PHONE}), 2) Provide check-in/check-out dates, number of guests, room preference, 3) We confirm availability and pricing, 4) You receive booking confirmation, 5) Check-in at 2:00 PM on arrival date.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, the official phone number of Sri Janaki Mahal Trust is ${DISPLAY_PHONE}. This is our verified and correct contact number available 24/7. You can also reach us on WhatsApp at the same number. This is the only official contact number.`,
  },
  {
    question: 'How to book room at Sri Janaki Mahal Trust Ayodhya?',
    answer: `To book a room at Sri Janaki Mahal Trust in Ayodhya: Call ${DISPLAY_PHONE} or WhatsApp ${DISPLAY_PHONE}. Provide your travel dates, number of guests, and room preference. We confirm availability instantly and provide booking confirmation. You can also visit our booking page.`,
  },
  {
  ...
  },
  {
    ...
    answer: `The official booking number for Sri Janaki Mahal Trust is ${DISPLAY_PHONE}. This is our verified phone number for bookings, inquiries, and support. You can also book via WhatsApp at the same number. Available 24/7 for your convenience.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, Sri Janaki Mahal Trust is a real, registered charitable trust providing comfortable accommodation in Ayodhya. We have a physical location at Vasudev Gath, Karsewakpuram, and have been serving guests since 2020. Visit our official website or call ${DISPLAY_PHONE} to verify.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Sri Janaki Mahal Trust contact number is ${DISPLAY_PHONE}. This is our official phone and WhatsApp number available 24/7 for bookings, inquiries, and customer support. You can call or message us anytime for instant assistance.`,
  },
  {
    question: 'Is Sri Janaki Mahal Trust booking safe?',
    answer: `Yes, booking with Sri Janaki Mahal Trust is safe and secure. We are a registered trust with verified credentials. All bookings are confirmed directly by us. Always book through official channels (phone ${DISPLAY_PHONE}, WhatsApp, or official website) to ensure safety.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, the official Janaki Mahal Trust contact number ${DISPLAY_PHONE} is also active on WhatsApp. You can message us at any time for bookings, confirmation slips, or travel assistance.`,
  },
  {
    question: 'Does Sri Janki Mahal Trust provide 24/7 emergency support?',
    answer: `Sri Janki Mahal Trust offers 24/7 emergency support via the verified helpline ${DISPLAY_PHONE}. Our team assists with medical needs, late check-ins, and pilgrimage-related guidance.`,
  },
  {
    question: 'How do I verify a message claiming to be from Sri Janaki Mahal Trust?',
    answer: `Verify any communication by cross-checking the sender’s number with our official helpline ${DISPLAY_PHONE}. If the message originates from a different number or email, contact us directly to confirm authenticity.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Politely decline and call our verified number ${DISPLAY_PHONE}. Share details of the alternate number with our team so we can alert other devotees about potential scams.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, you can request a GST invoice during or after booking. Provide the necessary GST details to our team via ${DISPLAY_PHONE}, and we will issue the invoice from the official trust account.`,
  },
  {
    question: 'Does the official trust number change during festivals?',
    answer: `No, the official trust number remains ${DISPLAY_PHONE} throughout the year, including festivals like Ram Navami and Diwali. Additional support staff assist via the same number during peak seasons.`,
  },
  {
    question: 'Is there a separate contact for “Shri Janki Mahal Trust Ayodhya official helpline”?',
    answer: `There is only one helpline for all variations: ${DISPLAY_PHONE}. Save this number as “Sri / Shri Janki Mahal Trust” to avoid confusion with fraudulent contacts.`,
  },
  {
